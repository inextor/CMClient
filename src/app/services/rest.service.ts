...
export class RestService {
	...
	//End Functions
		...
		/*
	callMethodGet(method:string,parameters:any):Observable<any>
	{
		...
		return this.http.get<any>( `${this.urlBase}/${method}`,{params: params, withCredentials: false, observe:'response' });
	}


	callMethodPut(method:string,params:any,withCredentials:boolean):Observable<any>
	{
		return this.http.post<any>(`${this.urlBase}/${method}`,params,{withCredentials} );
	}

	callMethodPost(method:string,params:any,withCredentials:boolean ):Observable<any>
	{
		return this.http.post<any>(`${this.urlBase}/${method}`,{params, withCredentials } );
	}

	callMethodDelete(method:string,params, withCredentials:boolean):Observable<any>
	{
		return this.http.delete<any>(`${this.urlBase}/${method}`,{params, withCredentials } );
	}
/*
	getUsuario(id):Observable<Usuario>
	{
		...
		return this.http.get<Usuario>(`${this.urlBase}/usuario.php`,{params, withCredentials: true } );
	}
	//getUsuario():Usuario
	//{
	//	let usr_string = localStorage.getItem('user');

	//	if( usr_string == null )
	//		return null;

	//	let obj = JSON.parse( usr_string );
	//	return obj;
	//}
	...
	{
		return this.http.post<Paciente>(`${this.urlBase}/paciente`,paciente,{ headers: this.getSessionHeaders(),withCredentials:true});
	}
	...
	{
		return this.http.put(`${this.urlBase}/cita.php`,cita,{headers: this.getSessionHeaders()});
	}

	getCitas(id_usuario,inicio:string,fin:string):Observable<Respuesta<Cita>>
	{
		let params = new HttpParams();
		...
		if( inicio !== null )
		{
			params = params.append('busqueda_fecha_inicio',inicio );
		}

		if( fin !== null )
		{
			params = params.append('busqueda_fecha_fin',fin );
		}
		return this.http.get<Respuesta<Cita>>(`${this.urlBase}/citas.php`,{ params, headers: this.getSessionHeaders(),withCredentials:true});
	}



	requests = {
		get: (url, params) => this.http.get<any>( `${this.urlBase}/${url}`,{ params: params, headers: this.getSessionHeaders(), withCredentials:true}),
		post: (url, body) => this.http.post<any>(`${this.urlBase}/${url}` ,body ,{ headers: this.getSessionHeaders(), withCredentials:true})
	}

	doctor = {
		horario: {
			create: (idDoctor, idCentroMedico, horarios) => this.requests.post('horario_doctor.php', { id_doctor: idDoctor, id_centro_medico: idCentroMedico, horarios }),
			get: (idDoctor, idCentroMedico) => this.requests.get('horario_doctor.php', { id_doctor: idDoctor, id_centro_medico: idCentroMedico })
		},
		agenda: {
			get: (idDoctor, idCentroMedico) => this.requests.get('searchCita.php', { id_doctor: idDoctor, id_centro_medico: idCentroMedico })
		}
	}

	cita = {
		create: (cita) => this.requests.post('cita.php', cita)
	}

	getDoctor(idDoctor:number):Observable<Doctor>
	{
		let params = new HttpParams();
		params = params.append('id',''+idDoctor);

		return this.http.get<Doctor>(`${this.urlBase}/doctor.php`,{ params, headers: this.getSessionHeaders(),withCredentials:true});
	}

	getDoctores(id_organizacion:number=1):Observable<Respuesta<Doctor>>
	{
		let params = new HttpParams();
		params = params.append('id_organizacion',''+this.getOrganizacion());

		return this.http.get<Respuesta<Doctor>>(`${this.urlBase}/doctor.php`,{params, headers: this.getSessionHeaders(),withCredentials:true});
	}


	actualizarDoctor(doctor:Doctor):Observable<Doctor>
	{
		return this.http.put<Doctor>(`${this.urlBase}/doctor.php`,doctor,{ headers: this.getSessionHeaders(),withCredentials:true});
	}


	getCentroMedico(id:number):Observable<Centro_Medico>
	{
		let params = new HttpParams();
		params = params.set('id',''+id)
		return this.http.get<Centro_Medico>(`${this.urlBase}/centro_medico.php`,{params, headers: this.getSessionHeaders(),withCredentials:true});
	}

	getCentrosMedicosPorOrganizacion(id:number):Observable<Respuesta<Centro_Medico>>
	{
		let params = new HttpParams();
		params = params.set('id_organizacion',''+id)
		return this.http.get<Respuesta<Centro_Medico>>(`${this.urlBase}/centro_medico.php`,{params, headers: this.getSessionHeaders(),withCredentials:true});
	}

	agregarCentroMedico(centro_medico:Centro_Medico):Observable<Centro_Medico>
	{
		centro_medico.id_organizacion = 1;
		return this.http.post<Centro_Medico>(`${this.urlBase}/centro_medico.php`,centro_medico,{ headers: this.getSessionHeaders(),withCredentials:true});
	};

	actualizarCentroMedico(centro_medico:Centro_Medico):Observable<Centro_Medico>
	{
		return this.http.put<Centro_Medico>(`${this.urlBase}/centro_medico.php`,centro_medico,{ headers: this.getSessionHeaders(),withCredentials:true});
	};
	...
	getServicios():Observable<Respuesta<Servicio>>
	{
		let params = new HttpParams();
		params = params.append('id_organizacion',''+1);

		return this.http.get<Respuesta<Servicio>>(`${this.urlBase}/servicio.php`, {params,headers:this.getSessionHeaders(), withCredentials: true })
	}

	getPaciente(id_paciente):Observable<Paciente>
	{
		let params = new HttpParams();
		params = params.append('id',''+id_paciente);
		return this.http.get<Paciente>(`${this.urlBase}/paciente.php`, {params,headers:this.getSessionHeaders(), withCredentials: true })
	}
	...
	// 	let params = new HttpParams();
	// 	params = params.append('id',''+id_paciente);
	// 	// return this.http.get<Respuesta<Paciente>>(`${this.urlBase}/paciente.php`, {params,headers:this.getSessionHeaders(), withCredentials: true })
	// }

	getPacientes(id_organizacion:number=1,limite:number=100,pagina:number=0):Observable<Respuesta<Paciente>>
	{
		let params = new HttpParams();
		params = params.append('id_organizacion',''+id_organizacion);
	...
	updatePaciente(paciente):Observable<Paciente>
	{
		return this.http.put<Paciente>(`${this.urlBase}/paciente.php`, paciente,{headers:this.getSessionHeaders(), withCredentials: true })
	}
	...
	//	let result = this.http.get<any>( `${this.urlBase}/logout.php`,{ withCredentials: true });
	...
	getPreguntas():Observable<Respuesta<Pregunta_Historia_Clinica>>
	{
		return this.http.get<Respuesta<Pregunta_Historia_Clinica>>(`${this.urlBase}/pregunta_historia_clinica.php`,{headers:this.getSessionHeaders()});
	}

	agregarPregunta(pregunta:Pregunta_Historia_Clinica):Observable<Pregunta_Historia_Clinica>
	{
		return this.http.post<Pregunta_Historia_Clinica>(`${this.urlBase}/pregunta_historia_clinica.php`, pregunta,{headers:this.getSessionHeaders()});
	}

	agregarEspecialidadPregunta(id_pregunta_historia_clinica,id_especialidad ):Observable<Especialidad_Pregunta>
	{
		return this.http.post<Especialidad_Pregunta>(`${this.urlBase}/especialidad_pregunta.php`,{id_pregunta_historia_clinica,id_especialidad},{headers:this.getSessionHeaders()});
	}

	editEspecialidadPregunta(especialidad_pregunta:Especialidad_Pregunta, accion:string = 'edit'):Observable<Especialidad_Pregunta>
	{
		let a:any = {};
		for(let i in especialidad_pregunta )
		{
			a[i] = especialidad_pregunta[i];
		}

		a.accion = accion;

		return this.http.put<Especialidad_Pregunta>(`${this.urlBase}/especialidad_pregunta.php`,a,{headers:this.getSessionHeaders()});
	}

	deleteEspecialidadPregunta(id:number):Observable<Especialidad_Pregunta>
	{
		console.log("REMOVING");
		let params = new HttpParams();
		params = params.append('id',''+id);
		return this.http.delete<Especialidad_Pregunta>(`${this.urlBase}/especialidad_pregunta.php`,{params,headers:this.getSessionHeaders()});
	}

	getTipoGasto(id):Observable<Tipo_Gasto>
	{
		let params = new HttpParams();
		params = params.append('id',''+id);
		return this.http.get<Tipo_Gasto>(`${this.urlBase}/tipo_gasto.php`,{params,headers:this.getSessionHeaders()});
	}

	getTiposGasto(tipo:Tipo_Gasto):Observable<Respuesta<Tipo_Gasto>>
	{
		let params = new HttpParams();
		for(let i in tipo)
		{
			if( i == 'id' )
				continue;
			params = params.append(i,''+tipo[i]);
		}
		return this.http.get<Respuesta<Tipo_Gasto>>(`${this.urlBase}/tipo_gasto.php`,{params,headers:this.getSessionHeaders()});
	}

	agregarTipoGasto(tipoGasto:Tipo_Gasto):Observable<Tipo_Gasto>
	{
		return this.http.post<Tipo_Gasto>(`${this.urlBase}/tipo_gasto.php`,tipoGasto,{headers:this.getSessionHeaders()});
	}

	updateTipoGasto(tipoGasto:Tipo_Gasto):Observable<Tipo_Gasto>
	{
		return this.http.put<Tipo_Gasto>(`${this.urlBase}/tipo_gasto.php`,tipoGasto,{headers:this.getSessionHeaders()});
	}

	agregarGastoCentroMedico(gasto:Gasto_Centro_Medico):Observable<Gasto_Centro_Medico>
	{
		return this.http.post<Gasto_Centro_Medico>(`${this.urlBase}/gasto_centro_medico.php`,gasto,{headers:this.getSessionHeaders()});
	}

	actualizarUsuario(usuario:Usuario):Observable<Usuario>
	{
		return this.http.put<Usuario>( `${this.urlBase}/usuario.php`,usuario,{headers: this.getSessionHeaders(), withCredentials: true });
	}

	searchGastoCentroMedico(search:SearchGastoCentroMedico):Observable<Respuesta<SearchGastoCentroMedicoResponse>>
	{
		let params = params.append(i,''+tipo[i]);
		for(let i in search)
		{
			if( search[i ] )
				params = params.append(i,''+search[i]);
		}

		return this.http.get(`${this.urlBase}/searchGastoCentroMedico.php`,{params,headers:this.getSessionHeaders(),withCredentials:true});
	}

	searchCitas(cita:SearchCitaRequest):Observable<Respuesta<SearchCitaResponse>>
	{
		let params = new HttpParams();
		for(let i in cita)
		{
			params = params.append(i,''+cita[i] );
		}
		return this.http.get<Respuesta<SearchCitaResponse>>(`${this.urlBase}/searchCita.php`,{ params, headers: this.getSessionHeaders()});
	}

	getServicio(id:number):Observable<ServicioResponseItem>
	{
		let params = new HttpParams();
		params = params.append('id',''+id);

		return this.http.get<ServicioResponseItem>(`${this.urlBase}/servicio.php`, {params,headers:this.getSessionHeaders(), withCredentials: true })
	}
