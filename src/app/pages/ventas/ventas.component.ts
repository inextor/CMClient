...
export class VentasComponent extends BaseComponent implements OnInit {
	...
	ngOnInit()
	{
		this.route.queryParams.subscribe( params =>
		{
			...
			//this.venta_search.eq.cupon	= params.get("eq.cupon")?params.get("eq.cupon"):null;
			//this.venta_search.le.cupon	= params.get("le.cupon")?params.get("le.cupon"):null;
			//this.venta_search.lt.cupon	= params.get("lt.cupon")?params.get("lt.cupon"):null;
			//this.venta_search.ge.cupon	= params.get("ge.cupon")?params.get("ge.cupon"):null;
			//this.venta_search.gt.cupon	= params.get("gt.cupon")?params.get("gt.cupon"):null;
			//this.venta_search.lk.cupon	= params.get("lk.cupon")?params.get("lk.cupon"):null;
			...
			//this.venta_search.eq.sucursal	= params.get("eq.sucursal")?params.get("eq.sucursal"):null;
			//this.venta_search.le.sucursal	= params.get("le.sucursal")?params.get("le.sucursal"):null;
			//this.venta_search.lt.sucursal	= params.get("lt.sucursal")?params.get("lt.sucursal"):null;
			//this.venta_search.ge.sucursal	= params.get("ge.sucursal")?params.get("ge.sucursal"):null;
			//this.venta_search.gt.sucursal	= params.get("gt.sucursal")?params.get("gt.sucursal"):null;
			//this.venta_search.lk.sucursal	= params.get("lk.sucursal")?params.get("lk.sucursal"):null;
			...
			//this.venta_search.eq.tipo_cliente	= params.get("eq.tipo_cliente")?params.get("eq.tipo_cliente"):null;
			//this.venta_search.le.tipo_cliente	= params.get("le.tipo_cliente")?params.get("le.tipo_cliente"):null;
			//this.venta_search.lt.tipo_cliente	= params.get("lt.tipo_cliente")?params.get("lt.tipo_cliente"):null;
			//this.venta_search.ge.tipo_cliente	= params.get("ge.tipo_cliente")?params.get("ge.tipo_cliente"):null;
			//this.venta_search.gt.tipo_cliente	= params.get("gt.tipo_cliente")?params.get("gt.tipo_cliente"):null;
			//this.venta_search.lk.tipo_cliente	= params.get("lk.tipo_cliente")?params.get("lk.tipo_cliente"):null;
